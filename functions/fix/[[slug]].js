...
function renderFixPage(slug) {
    ...
    const jsonLd = JSON.stringify({
        ...
        'provider': { '@type': 'Organization', 'name': 'OmniGuide', 'url': 'https://www.omnivibe.app' },
    });
    ...
    const breadcrumbLd = JSON.stringify({
        ...
        '@type': 'BreadcrumbList',
        'itemListElement': [
            { '@type': 'ListItem', 'position': 1, 'name': 'OmniGuide', 'item': 'https://www.omnivibe.app' },
...
<head>
    ...
    <!-- Primary SEO -->
    <title>How to Fix: ${title} | OmniGuide DIY Repair</title>
    ...
    <meta name="keywords" content="${title}, how to fix ${title}, ${meta.category}, repair guide, DIY, OmniGuide">
    ...
    <meta property="og:site_name" content="OmniGuide">
    ...
    <meta name="twitter:title" content="How to Fix: ${title} | OmniGuide">
            ...
            <div class="faq-accordion">
                <details class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>OmniGuide uses Gemini AI trained on vast repair and technical documentation databases. The guides are tailored to your specific make, model, and error code. For critical safety repairs (brakes, suspension, airbags), we always recommend consulting a certified mechanic as a final verification step.</p>
                    </div>
                </details>
                <details class="faq-item">
    ...
    <div id="auth-modal" class="modal-overlay" style="display:none;" role="dialog" aria-modal="true" aria-labelledby="auth-title">
        <div class="modal">
            <div class="modal-header">
                <h3 id="auth-title">Sign in to OmniGuide</h3>
