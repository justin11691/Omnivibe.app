...
window.OmniGuideApp = {
    ...
    _renderTeaserPartial(partial) {
        ...
        if (vidEl) {
            vidEl.innerHTML = `
                <div class="preview-video-placeholder" style="grid-column:1/-1;aspect-ratio:16/9;background:#111;border-radius:6px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0.75rem;">
                    ...
                    <span style="color:#fff;font-size:0.9rem;opacity:0.8;">Curated tutorial videos will appear here.</span>
                </div>`;
        }
